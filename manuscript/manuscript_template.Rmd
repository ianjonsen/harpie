...
keywords: | 
 A list in alphabetical order not exceeding eight words or short phrases. The most important key-words should appear in the title and the abstract as well as the key-word list.
...
We used R for our calculations [@R_Core_Team_2016], and we used package `knitcitations` [@Boettiger_2017] to make the bibliography.
